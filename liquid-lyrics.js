...
`;var De="liquid-lyrics-button";function Yt(){let t=document.getElementById(De);if(t)return t;let e=document.querySelector(".main-nowPlayingBar-extraControls");if(!e)return null;let i=document.createElement("button");return i.id=De,i.className="liquid-lyrics-button",i.setAttribute("aria-label","Liquid Lyrics"),i.innerHTML=Le,L(i,"Liquid Lyrics"),i.addEventListener("click",()=>{Wt(),i.classList.toggle("active",h())}),e.prepend(i),i}function Gt(){let t=document.getElementById(De);t&&t.classList.toggle("active",h())}var H="liquid-lyrics-sidebar-card",Xt="liquid-lyrics-sidebar-card-collapsed",Tn=300,Sn=2e3,Ue={fullscreen:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8.2 4H4v4.2"/><path d="M15.8 4H20v4.2"/><path d="M20 15.8V20h-4.2"/><path d="M4 15.8V20h4.2"/></svg>',open:'<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="14" rx="3"/><path d="M8 9h8"/><path d="M8 13h5"/></svg>',roman:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.5 18.5 9.7 5.5h1.9l5.2 13"/><path d="M7 13.4h7.3"/><path d="M18.6 7.2h2.2"/><path d="M19.7 6.1v2.2"/></svg>'},k=null,we="Loading lyrics...",Y=!1,ei=!1,je=null,$e=!1,Zt=null,P=null,Kt=0,Ye=!1,Jt=[];function Se(){let t=document.getElementById(H);if(t)return B(t),t;let e=document.createElement("section");e.id=H,e.className="liquid-lyrics-sidebar-card",e.innerHTML=`
  ...
  `;let i=e.querySelector(".ll-sidebar-header-main"),n=e.querySelector(".ll-sidebar-collapse-btn"),r=e.querySelector(".ll-sidebar-roman-toggle"),s=e.querySelector(".ll-sidebar-fullscreen-toggle"),l=e.querySelector(".ll-sidebar-open-toggle"),a=()=>{let c=!e.classList.contains("collapsed");localStorage.setItem(Xt,String(c)),Qt(e),M()};i?.addEventListener("click",a),n?.addEventListener("click",a),r?.addEventListener("click",c=>{c.stopPropagation(),de(!y()),Te(!0),window.dispatchEvent(new Event(ne))}),s?.addEventListener("click",c=>{c.stopPropagation(),Ft(!1)}),l?.addEventListener("click",c=>{c.stopPropagation(),be()}),n&&L(n,"Toggle mini lyrics"),r&&L(r,"Romanization"),s&&L(s,"Fullscreen"),l&&L(l,"Open Liquid Lyrics");let o=e.querySelector(".ll-sidebar-mini-viewport"),d=e.querySelector(".ll-sidebar-mini-lines");return k=new D({container:d,scroller:o,variant:"sidebar",dotLiftPx:10,onRomanizationAvailability:c=>{Y=c,oe(e)}}),window.addEventListener(ne,()=>{Te(!h()),oe(e)}),Qt(e),B(e),kn(),Rn(),Ke(we),M(),e}function Ge(t,e="No lyrics available"){let i=Se();we=t?"Live lyrics":e,Y=!1,k?.setLyrics(t),!t||!k?.hasLyrics?Ke(we):Te(!h()),oe(i),M()}function ti(t){we=t,Y=!1;let e=document.getElementById(H);e&&(k?.setLyrics(null),Ke(t),oe(e),M())}function M(){let t=document.getElementById(H);if(!t)return;B(t);let e=h();t.classList.toggle("ll-hidden",e),t.dataset.romanized=String(y()),oe(t);let i=t.classList.contains("collapsed"),n=!e&&!i;k?.setEnabled(n),n&&y()&&!ei&&Te(!0)}function Ze(){B()}function Te(t){k&&(k.setRomanized(y(),t),ei=t||!y())}function Ke(t){if(!k)return;let e=document.createElement("div");e.className="ll-sidebar-mini-empty",e.textContent=t,k.container.replaceChildren(e)}function oe(t){let e=t.querySelector(".ll-sidebar-roman-toggle");if(!e)return;let i=Y&&y();e.hidden=!Y,e.disabled=!Y,e.classList.toggle("active",i),e.setAttribute("aria-pressed",String(i))}function Qt(t){let e=localStorage.getItem(Xt)==="true";t.classList.toggle("collapsed",e),t.querySelector(".ll-sidebar-header-main")?.setAttribute("aria-expanded",String(!e))}function B(t=document.getElementById(H)){if(!t)return;let e=En();e&&(t.parentElement!==e||e.lastElementChild!==t)&&e.appendChild(t)}function En(){if(P?.isConnected)return P;P=null;let t=document.querySelector(".Root__right-sidebar"),e=t?.querySelector(".main-nowPlayingView-nowPlayingWidget")||document.querySelector(".main-nowPlayingView-nowPlayingWidget")||t?.querySelector(".main-nowPlayingView-nowPlayingGrid")||document.querySelector(".main-nowPlayingView-nowPlayingGrid");if(e)return P=e,e;let i=performance.now();if(i-Kt<Sn)return t??null;Kt=i;let n=ae(["nowplayingview","nowplayingwidget"],t??document)||ae(["nowplaying","widget"],t??document)||ae(["nowplayingview","nowplayinggrid"],t??document)||ae(["nowplaying","grid"],t??document)||ae(["right","sidebar"]);return P=n,n??t}function ae(t,e=document){let i=t.map(n=>n.toLowerCase());for(let n of Array.from(e.querySelectorAll("*"))){let r=(n.getAttribute("class")||"").toLowerCase();if(i.every(s=>r.includes(s)))return n}return null}function kn(){je||(je=new MutationObserver(()=>{Mn()}),je.observe(document.body,{childList:!0,subtree:!0}),Je())}function Mn(){$e||($e=!0,setTimeout(()=>{$e=!1,Je();let t=document.getElementById(H);t&&(t.isConnected&&P?.isConnected&&t.parentElement===P||B(t))},Tn))}function Rn(){Zt||(Zt=setInterval(()=>{Je(),B()},1e3))}function Je(){if(!!document.querySelector(".Root__cinema-view")){Ye=!0;return}Ye&&(Ye=!1,qn())}function qn(){Jt.forEach(t=>clearTimeout(t)),Jt=[80,260,620,1100].map(t=>setTimeout(()=>{let e=document.getElementById(H)??Se();P=null,B(e),M()},t))}var ii=`\uFEFF/* ==========================================================================
   Liquid Lyrics
   --------------------------------------------------------------------------
...
.liquid-lyrics-sidebar-card .liquid-lyrics-line.past:not(.active):not(.liquid-lyrics-interlude) {
  opacity: 0.4;
}
...
`;function ni(){let t="liquid-lyrics-styles";if(document.getElementById(t))return;let e=document.createElement("style");e.id=t,e.textContent=ii,document.head.appendChild(e)}async function In(){await q(()=>Spicetify?.Player?.data&&Spicetify?.CosmosAsync),ni(),$(),Se(),await q(()=>document.querySelector(".main-nowPlayingBar-extraControls")).catch(()=>null),Yt();let t=null,e=null,i="Loading lyrics...",n=0,r=ri();async function s(){let u=Spicetify.Player.data;if(!u?.item?.uri)return;let m=u.item.uri,g=m.includes(":")?m.split(":")[2]:m;if(g===t){Ze(),M();return}t=g,e=null,i="Loading lyrics...",Ze(),ti(i),h()&&re(i),await l(g,u.item)}async function l(u,m){let g=++n,R=await st({id:u,data:{name:m.name}});if(!(g!==n||u!==t)){if(R.status==="success"&&R.data){e=R.data,i="",Ge(R.data),h()&&Oe(R.data);return}e=null,i=R.status==="missing_lyrics"?"No lyrics available for this song":"Could not load lyrics",Ge(null,i),h()&&re(i)}}Spicetify.Player.addEventListener("songchange",()=>{s()});let a=()=>{let u=ri();u!==r&&(r=u,h()&&ve())};setInterval(()=>{a()},250);let o=Spicetify.Platform?.History;typeof o?.listen=="function"&&o.listen(a);let d=h(),c=new MutationObserver(()=>{let u=h();if(Gt(),M(),u&&!d&&t)if(e)Oe(e);else if(i&&i!=="Loading lyrics...")re(i);else{let m=Spicetify.Player.data;if(m?.item?.uri){let g=m.item.uri.includes(":")?m.item.uri.split(":")[2]:m.item.uri;re("Loading lyrics..."),l(g,m.item)}}d=u}),p=document.getElementById("liquid-lyrics-panel");p&&c.observe(p,{attributes:!0,attributeFilter:["class"]}),M(),s()}In();function ri(){let e=Spicetify.Platform?.History?.location??{},i=e.pathname||e.path||e.uri||"";return`${location.href}|${i}`}})();
